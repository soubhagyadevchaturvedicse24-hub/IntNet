...
# Open single SQLite connection for all bindings and provenance
...
print(f"Ingested {len(node_id_map)} master nodes.")

# 2. Ingest Relationships & register target nodes
edges_inserted = 0
...
print(f"Total nodes registered: {len(node_id_map)}")
